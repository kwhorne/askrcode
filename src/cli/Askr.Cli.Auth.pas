...
begin
  ...
  try
    ...
    A('    '' key.</p></div><div>'' +');
    A('    ''<div class="card"><h2>Not wired up here yet'' +');
    A('    ''<span class="tag">next</span></h2>'' +');
    ...
    A('    '' only a public key.</p>'' +');
    A('    ''<p>The framework can verify them — see'' +');
    A('    '' <code>Askr.WebAuthn</code> — but this scaffold does not'' +');
    A('    '' create the table or the routes for you yet. You can build'' +');
    A('    '' it on top today; the ceremonies and the signature'' +');
    A('    '' verification are done and tested.</p></div></div></section>'';');
    A('end;');
    A('');
